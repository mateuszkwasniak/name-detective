...
export default function SearchCard({ searchResult }: Props) {
  ...
  return (
    <article className="w-fit h-fit border border-slate-50 rounded-md shadow-md p-16 flex gap-20 justify-center text-slate-800">
    <div className="flex flex-col">
      <h3 className="md:text-xl font-semibold mb-2">Date:</h3>
    ...
    <hr className="md:h-[25rem] border border-l-0 border-slate-200"/>
    <div className="flex flex-col">
      <h3 className="md:text-xl  font-semibold mb-8">Results:</h3>
